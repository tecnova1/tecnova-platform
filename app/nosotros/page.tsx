    ...
    <div className="max-w-4xl mx-auto px-6 py-20 space-y-12">
      ...
      <div className="pt-8 border-t border-slate-800 space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <a href="/nexo" className="group bg-slate-900/60 border border-emerald-900/60 p-6 rounded-2xl space-y-2 transition hover:-translate-y-0.5 hover:border-emerald-500/50 hover:bg-slate-900">
            ...
            <p className="text-xs text-slate-400 font-light">Método territorial para observar, registrar y comprender antes de innovar. Conecta ciudadanía, gestión y evidencia.</p>
          </a>
